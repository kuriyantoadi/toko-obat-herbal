                                        ...
                                        <div class="card-body p-4">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 col-lg-12">
                                                    <button class="btn btn-primary btn-block float-end my-2" data-bs-toggle="modal" data-bs-target="#modal_tambah_produk">
                                        ...
                                        <div class="col-md-6 col-xl-4 col-sm-6">
                                            ...
                                            <div class="product-grid6">
                                                ...
                                                <ul class="icons">
                                                    ...
                                                    <li><a href="../admin/produk_hapus.php?id=<?= $p['id_produk'] ?>" onclick="return confirm('Yakin ingin menghapus produk ini?')" class="btn btn-danger"><i class="fe fe-x"></i></a></li>
                                                </ul>
