<div class="modal fade" id="largemodal_edit<?= $d['id_kecamatan']; ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            ...
            <form action="../data-master/kec_edit.php" method="POST">
                <div class="modal-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">                            
                           <select name="id_kab_kota" class="form-control" id="" required>
                                <option value="<?= $d['id_kab_kota'] ?>">Pilihan Awal = ( <?= $d['nama_kab_kota'] ?> )</option>
                                    <?php
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input type="hidden" name="id_kecamatan" value="<?= $d['id_kecamatan'] ?>" class="form-control" required>
                            <input type="text" name="nama_kecamatan" value="<?= $d['nama_kecamatan'] ?>" class="form-control" required>
                        </div>
                    </div>
                </div>
