...
if (isset($_POST['checkout'])) {
    ...
    // Simpan ke tb_order
    mysqli_query($koneksi, "INSERT INTO tb_order (id_pelanggan, nama_pembeli, alamat_pembeli, no_hp, tanggal_order, total, status) 
                            VALUES ($id_pelanggan, '$nama', '$alamat', '$no_hp', '$tanggal', $total, 'Belum Lunas')");
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card p-4">
              ...
              <div class="mb-3">
                <label>Alamat</label>
                <textarea name="alamat_pembeli" class="form-control" required><?= htmlspecialchars($pelanggan['alamat_pelanggan']) ?></textarea>
              </div>
              <div class="mb-3">
                <label>No. HP</label>
                <input type="text" name="no_hp" class="form-control"
                       value="<?= htmlspecialchars($pelanggan['no_hp_pelanggan']) ?>" required>
              </div>
            </div>
          </div>
